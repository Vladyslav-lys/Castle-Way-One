...
/////// Diffuse:
                ...
                float3 diffuseColor = (_Ambient_light.rgb*_Diffuse_var.rgb);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                float3 diffColor = (_Ambient_light.rgb*_Diffuse_var.rgb);
                o.Albedo = diffColor;
